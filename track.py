...
os.system('echo mule123 | sudo -S chmod a+rw /dev/ttyUSB0')  # arduino for cameras 
os.system('echo mule123 | sudo -S chmod a+rw /dev/ttyACM0')  # arduino for motors 
...
def send_data(data):
    ...
    print(data)
    ser.write(data_str.encode())  # Send data to camera mov. arduino
    ser2.write(data_str.encode())  # Send data to motor mov. arduino
   
# open serial port for camera movement
ser = serial.Serial('/dev/ttyUSB0', 9600)
# open serial port for motor movement
